...
public class CountryDetails extends AppCompatActivity {
    ...
    TextView tvcountryName, countryTotalCases, countryTotalDeaths,
            countryTodayCases, countryTodayDeaths, countryRecovered;
    TextView countryActiveCases, countryCriticalCases, countryCasesPerMillion,
            countryDeathsPerMillion, countryTests, countryTestsPerMillion;
    Data fetched;
    ...
    public void updateUI() {
        ...
        StringRequest stringRequest = new StringRequest(
                Request.Method.GET, countryToFetch,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        Glide.with(CountryDetails.this)
                                .load(fetched.getCountryInfo().getFlag())
                                .into(countryFlag);
                        ...
                        countryCasesPerMillion.setText(
                                Format.number(fetched.getCasesPerOneMillion()));
                        countryDeathsPerMillion.setText(
                                Format.number(fetched.getDeathsPerOneMillion()));
                        countryTests.setText(Format.number(fetched.getTests()));
                        countryTestsPerMillion.setText(
                                Format.number(fetched.getTestsPerOneMillion()));
